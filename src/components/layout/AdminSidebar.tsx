  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-24 left-4 z-50 p-3 bg-white rounded-lg shadow-lg border border-slate-200 hover:bg-slate-50 transition-colors">
