    ...
    <div className="min-h-screen">
      <div className="container-1280 px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p className="text-sm sm:text-base text-slate-600">Manajemen pengguna dan hak akses</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
          <Card className="p-4 lg:p-6">
            <div className="flex items-center gap-3 lg:gap-4">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                <UserIcon className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
              </div>
              <div>
                <p className="text-xs lg:text-sm text-slate-600">Total Users</p>
                <p className="text-xl lg:text-2xl font-bold text-slate-900">2</p>
              </div>
            </div>
          </Card>
          <Card className="p-6">
